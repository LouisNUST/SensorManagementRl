...
class TFNeuralNetStochasticPolicyAgent:
    def __init__(self, env, num_input, learning_rate=1e-6, sigma=1.):
        self._sigma = sigma
        self._sess = tf.Session()
        self._states = tf.placeholder(tf.float32, (None, num_input), name="states")
...
class TFNeuralNetStochasticPolicyEpsilonGreedyAgent:
    def __init__(self, env, num_input, learning_rate=1e-6, sigma=1, init_exploration=0.5, final_exploration=0.0, anneal_steps=10000):
        self._sigma = sigma
        self._sess = tf.Session()
        self._states = tf.placeholder(tf.float32, (None, num_input), name="states")
